...
const loadPdfjs = async () => {
  ...
  const lib = m.getDocument ? m : m.default;
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const doc = await pdfjsLib.getDocument("/audit-elyon.pdf").promise;
        const infos = [];
        ...
        alert("Impossible de charger le PDF de l'audit : " + e.message);
      }
    })();
