    ...
    <div>
      ...
      <div className="card" style={{ marginBottom: 18 }}>
        ...
        <div className="row" style={{ alignItems: "flex-end", flexWrap: "wrap" }}>
          ...
          {(settings || {}).loginBg && (
            <>
              <img src={settings.loginBg} alt="fond" style={{ height: 46, borderRadius: 8, border: "1px solid #e3e8f0" }} />
              <button className="btn danger sm" onClick={() => saveSettings({ ...settings, loginBg: "", loginBgPreset: "" })}>Retirer</button>
            </>
          )}
        </div>
      </div>
